...
class _LanguageState extends State<Language> {
  ...
  String languageValue = LanguageKeys.english.name;

  @override
  void initState() {
    super.initState();
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      context.deviceLocale.toString() == 'tr_TR' ? languageValue = LanguageKeys.turkish.name : languageValue = LanguageKeys.english.name ;
    });
  } 
